...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'nickname' => ['type' => 'string', 'length' => 60, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'nickname' => ['type' => 'unique', 'columns' => ['nickname'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
